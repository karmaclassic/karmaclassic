    ...
    nWeight(0)
{
    ...
    setWindowTitle(tr("KarmaClassic") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a KarmaClassic address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About KarmaClassic"), this);
    aboutAction->setStatusTip(tr("Show information about KarmaClassic"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for KarmaClassic"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("KarmaClassic client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("KarmaClassic client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to KarmaClassic network", "", count));
}
...
{
    QString strTitle = tr("KarmaClassic") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid KarmaClassic address or malformed URI parameters."));
    }
